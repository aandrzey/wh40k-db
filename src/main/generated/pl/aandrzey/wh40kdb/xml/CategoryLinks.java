 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.battlescribe.net/schema/catalogueSchema}categoryLink" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "categoryLinks")
public class CategoryLinks {

    protected List<CategoryLink> categoryLink;
    ...
    public List<CategoryLink> getCategoryLink() {
        if (categoryLink == null) {
            categoryLink = new ArrayList<CategoryLink>();
        }
